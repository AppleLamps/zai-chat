...
title: "Core Parameters - Z.AI DEVELOPER DOCUMENT"
---
...
- [do\_sample](https://docs.z.ai/guides/overview/concept-param#do-sample)
- [temperature](https://docs.z.ai/guides/overview/concept-param#temperature)
- [top\_p](https://docs.z.ai/guides/overview/concept-param#top-p)
- [max\_tokens](https://docs.z.ai/guides/overview/concept-param#max-tokens)
...
## [​](https://docs.z.ai/guides/overview/concept-param\#quick-reference)  Quick Reference

| Parameter | Type | Default Value | Description |
| --- | --- | --- | --- |
| [do\_sample](https://docs.z.ai/guides/overview/concept-param#do_sample) | Boolean | `true` | Whether to sample the output to increase diversity. |
...
| [top\_p](https://docs.z.ai/guides/overview/concept-param#top_p) | Float | (Model dependent) | Controls diversity through nucleus sampling, recommended to use either this or `temperature`. |
| [max\_tokens](https://docs.z.ai/guides/overview/concept-param#max_tokens) | Integer | (Model dependent) | Limits the maximum number of tokens generated in a single call. |
...
## [​](https://docs.z.ai/guides/overview/concept-param\#parameter-details)  Parameter Details

### [​](https://docs.z.ai/guides/overview/concept-param\#do-sample)  do\_sample
...
### [​](https://docs.z.ai/guides/overview/concept-param\#temperature)  temperature
...
### [​](https://docs.z.ai/guides/overview/concept-param\#top-p)  top\_p
...
### [​](https://docs.z.ai/guides/overview/concept-param\#max-tokens)  max\_tokens
...
### [​](https://docs.z.ai/guides/overview/concept-param\#stream)  stream
...
### [​](https://docs.z.ai/guides/overview/concept-param\#thinking)  thinking
...
## [​](https://docs.z.ai/guides/overview/concept-param\#related-concepts)  Related Concepts
