...
title: "Errors - Z.AI DEVELOPER DOCUMENT"
---
...
## [​](https://docs.z.ai/api-reference/api-code\#http-status-code)  HTTP Status Code
...
## [​](https://docs.z.ai/api-reference/api-code\#business-error-codes)  Business Error Codes
...
## [​](https://docs.z.ai/api-reference/api-code\#error-shapes)  Error Shapes
...
## [​](https://docs.z.ai/api-reference/api-code\#error-example)  Error Example
