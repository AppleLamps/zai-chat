---
url: "https://docs.z.ai/scenario-example/develop-tools/opencode"
title: "OpenCode - Z.AI DEVELOPER DOCUMENT"
---
...
- [Step 1: Installing OpenCode](https://docs.z.ai/scenario-example/develop-tools/opencode#step-1:-installing-opencode)
- [Step 2: Getting Started](https://docs.z.ai/scenario-example/develop-tools/opencode#step-2:-getting-started)
...
## [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#step-1:-installing-opencode)  Step 1: Installing OpenCode
...
## [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#step-2:-getting-started)  Step 2: Getting Started
...
Refer to the [Vision Understanding MCP Server](https://docs.z.ai/devpack/mcp/vision-mcp-server) [Web Search MCP Server](https://docs.z.ai/devpack/mcp/search-mcp-server) [Web Reader MCP Server](https://docs.z.ai/devpack/mcp/reader-mcp-server) documentation; once configured, you can use them in OpenCode.OpenCode’s share feature allows you to create public links to your OpenCode conversations, so you can collaborate with teammates or get help from others.

#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#how-it-works)  How it works
...
#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#share-2)  Share
...
#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#un-share)  Un-share
...
## [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#ide-extensions)  IDE Extensions

OpenCode integrates with VS Code, Cursor, or any IDE that supports a terminal.

#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#installation)  Installation
...
#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#usage)  Usage
...
## [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#github-workflow)  GitHub Workflow
...
#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#features)  Features
...
#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#installation-2)  Installation
...
#### [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#examples)  Examples
...
## [​](https://docs.z.ai/scenario-example/develop-tools/opencode\#resources)  Resources
...
![Description](https://mintcdn.com/zhipu-32152247/fQm1SxNtD2jBDQ3i/resource/opencode.png?w=840&fit=max&auto=format&n=fQm1SxNtD2jBDQ3i&q=85&s=be698a4b0961ae0c1622a32bca0d67e9)