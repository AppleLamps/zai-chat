            ...
            properties:
              model:
                allOf:
                  - type: string
                    description: >-
                      The model code to be called. GLM-4.6 are the latest
                      flagship model series, foundational models specifically
              ...
              messages:
                allOf:
                  - type: array
                    description: >-
                      The current conversation message list as the model’s
                      prompt input, provided in JSON array format,
                      e.g.,`{“role”: “user”, “content”: “Hello”}`. Possible
                      message types include system messages, user messages,
                      assistant messages, and tool messages. Note: The input
                      must not consist of system messages or assistant messages
                      only.
                    items:
                      oneOf:
                        - title: User Message
                        ...
                        - title: Assistant Message
                          ...
                          properties:
                            ...
                            tool_calls:
                              type: array
                              description: >-
                                Tool call messages generated by the model. When
                                this field is provided, content is usually
                                empty.
                              items:
                                type: object
                                properties:
                                  ...
                                  type:
                                    type: string
                                    description: >-
                                      Tool type, supports web_search, retrieval,
                                      function
                                    enum:
                                      - function
                                      - web_search
                                  ...
                                  function:
                                    type: object
                                    description: >-
                                      Function call information, not empty when
                                      type is function
                                    properties:
                                      name:
                                        type: string
                        ...
                        - title: Tool Message
                          ...
                          properties:
                            ...
                            tool_call_id:
                              type: string
                              description: >-
                                Indicates the tool call ID corresponding to this
                                message
                          required:
                            - role
                            - content
              ...
              request_id:
                allOf:
                  - type: string
                    description: >-
                      Passed by the user side, needs to be unique; used to
                      distinguish each request. If not provided by the user
                      side, the platform will generate one by default.
              do_sample:
                allOf:
                  - type: boolean
                    example: true
                    default: true
                    description: >-
                      When do_sample is true, sampling strategy is enabled; when
                      do_sample is false, sampling strategy parameters such as
                      temperature and top_p will not take effect. Default value
                      is `true`.
              stream:
                allOf:
                  - type: boolean
                    ...
                    default: false
                    description: >-
                      This parameter should be set to false or omitted when
                      using synchronous call. It indicates that the model
                      returns all content at once after generating all content.
                      Default value is false. If set to true, the model will
                      return the generated content in chunks via standard Event
                      Stream. When the Event Stream ends, a `data: [DONE]`
              ...
              temperature:
                allOf:
                  - type: number
                    description: >-
                      Sampling temperature, controls the randomness of the
                      output, must be a positive number within the range: `[0.0,\
                      1.0]`. The GLM-4.6 series default value is `1.0`, GLM-4.5
                      series default value is `0.6`, GLM-4-32B-0414-128K default
                      value is `0.75`.
                    format: float
                    example: 1
                    default: 1
              ...
              top_p:
                allOf:
                  - type: number
                    description: >-
                      Another method of temperature sampling, value range is:
                      `[0.01, 1.0]`. The GLM-4.6, GLM-4.5 series default value
                      is `0.95`, GLM-4-32B-0414-128K default value is `0.9`.
                    format: float
                    example: 0.95
                    default: 0.95
                    minimum: 0.01
              ...
              max_tokens:
                allOf:
                  - type: integer
                    description: >-
                      The maximum number of tokens for model output, the GLM-4.6
                      series supports 128K maximum output, the GLM-4.5 series
                      supports 96K maximum output, the GLM-4.5v series supports
                      16K maximum output, GLM-4-32B-0414-128K supports 16K
                      maximum output.
                    example: 1024
                    minimum: 1
                    maximum: 131072
                ...
                allOf:
                  - type: boolean
                    ...
                    description: >-
                      ...
                      Default value is false. Only supported by GLM-4.6. Refer
                      the [Stream Tool Call](/guides/tools/stream-tool)
              tools:
                allOf:
                  - type: array
                    description: >
                  ...
                  - oneOf:
                      - type: string
                        enum:
                          - auto
                        description: >-
                          Used to control how the model selects which function
                          to call. This is only applicable when the tool type is
                          function. The default value is auto, and only auto is
                          supported.
              ...
              stop:
                allOf:
                  - type: array
                    description: >-
                      Stop word list. Generation stops when the model encounters
                      any specified string. Currently, only one stop word is
                      supported, in the format ["stop_word1"].
                    items:
                      type: string
                    maxItems: 1
              response_format:
                allOf:
                  - type: object
                    description: >-
                      Specifies the response format of the model. Defaults to
                      text. Supports two formats:{ "type": "text" } plain text
                      mode, returns natural language text, { "type":
                      "json_object" } JSON mode, returns valid JSON data. When
                      using JSON mode, it’s recommended to clearly request JSON
                    ...
                    properties:
                      type:
                        ...
                        default: text
                        description: >-
                          Output format type: text for plain text, json_object
              ...
              user_id:
                allOf:
                  - type: string
                    description: >-
                      Unique ID for the end user, 6–128 characters. Avoid using
            ...
            properties:
              model:
                allOf:
                  - type: string
                    description: >-
                      The model code to be called. GLM-4.5V are the new
                      generation of visual reasoning models.
                    example: glm-4.5v
                    default: glm-4.5v
                    enum:
                      - glm-4.5v
                ...
                allOf:
                  - type: array
                    description: >-
                      ...
                      e.g.,`{“role”: “user”, “content”: “Hello”}`. Possible
                      message types include system messages, user messages.
                      Note: The input must not consist of system or assistant
                      messages only.
                    items:
                      oneOf:
                        - title: User Message
                          ...
                          properties:
                            ...
                            content:
                              oneOf:
                                - type: array
                                  description: >-
                                    Multimodal message content, supports text,
                                    images, video, file
                                  items:
                                    $ref: >-
                                ...
                                - type: string
                                  description: >-
                                    Text message content (can switch to
                                    multimodal message above)
                                  example: >-
                                    What opportunities and challenges will the
                                    Chinese large model industry face in 2025?
                          required:
                ...
                allOf:
                  - type: number
                    description: >-
                      Sampling temperature, controls the randomness of the
                      output, must be a positive number within the range: `[0.0,\
                      1.0]`. The GLM-4.5V series default value is `0.8`.
                    format: float
                    example: 0.8
                    default: 0.8
                    minimum: 0
              ...
              top_p:
                allOf:
                  - type: number
                    description: >-
                      Another method of temperature sampling, value range is:
                      `[0.01, 1.0]`, value range is: `[0.01, 1.0]`. The GLM-4.5V
                      series default value is `0.6`.
                    format: float
                    example: 0.6
                    default: 0.6
                    minimum: 0.01
              ...
              max_tokens:
                allOf:
                  - type: integer
                    description: >-
                      The maximum number of tokens for model output, the
                      GLM-4.5V series supports 16K maximum output.
                    example: 1024
                    minimum: 1
                    maximum: 16384
              user_id:
              ...
              messages:
                ...
                - role: assistant
                  content: >-
                    ...
                    itself to solve a problem... What is recursion
                - role: user
                    ...
                    items:
                      ...
                      properties:
                        ...
                        finish_reason:
                          type: string
                          description: >-
                            Reason for model inference termination. Can be
                            ‘stop’, ‘tool_calls’, ‘length’, ‘sensitive’, or
                            ‘network_error’.
              usage:
                allOf:
                  - type: object
            ...
            file_url:
              ...
              properties:
                url:
                  type: string
                  description: >-
                    File URL address. Only GLM-4.5V supported. Supports formats
                    such as pdf、txt、word、jsonl、xlsx、pptx, with a maximum of 50.
              required:
                - url
              additionalProperties: false
          required:
    ...
    ChatThinking:
      ...
      properties:
        type:
          type: string
          description: >-
            Whether to enable the chain of thought(When enabled, GLM-4.6,
            GLM-4.5 and others will automatically determine whether to think,
            while GLM-4.5V will think compulsorily), default: enabled
          default: enabled
          enum:
            - enabled
            - disabled
