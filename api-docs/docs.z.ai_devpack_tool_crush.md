---
url: "https://docs.z.ai/devpack/tool/crush"
title: "Crush - Z.AI DEVELOPER DOCUMENT"
---
...
- [Step 1: Installing Crush](https://docs.z.ai/devpack/tool/crush#step-1:-installing-crush)
- [Step 2: Configuring the GLM Model](https://docs.z.ai/devpack/tool/crush#step-2:-configuring-the-glm-model)
...
- [Step 3: Modify Crush Configuration](https://docs.z.ai/devpack/tool/crush#step-3:-modify-crush-configuration)
...
- [Step 4: Complete Configuration and Pick model](https://docs.z.ai/devpack/tool/crush#step-4:-complete-configuration-and-pick-model)
- [Step 5: Vision Search Reader MCP](https://docs.z.ai/devpack/tool/crush#step-5:-vision-search-reader-mcp)
...
## [​](https://docs.z.ai/devpack/tool/crush\#step-1:-installing-crush)  Step 1: Installing Crush
...
## [​](https://docs.z.ai/devpack/tool/crush\#step-2:-configuring-the-glm-model)  Step 2: Configuring the GLM Model

### [​](https://docs.z.ai/devpack/tool/crush\#1-obtain-your-z-ai-api-key)  1\. Obtain Your Z.AI API Key

Visit Z.AI to get your [API Key](https://z.ai/manage-apikey/apikey-list).

### [​](https://docs.z.ai/devpack/tool/crush\#2-launch-crush-and-select-model)  2\. Launch Crush and Select Model
...
### [​](https://docs.z.ai/devpack/tool/crush\#3-enter-your-z-ai-api-key)  3\. Enter your Z.AI API key
...
## [​](https://docs.z.ai/devpack/tool/crush\#step-3:-modify-crush-configuration)  Step 3: Modify Crush Configuration

### [​](https://docs.z.ai/devpack/tool/crush\#1-locate-the-configuration-file)  1\. Locate the Configuration File
...
### [​](https://docs.z.ai/devpack/tool/crush\#2-switch-to-the-glm-coding-plan-endpoint)  2\. Switch to the GLM Coding Plan Endpoint

Open `providers.json` and update the GLM section.
...
## [​](https://docs.z.ai/devpack/tool/crush\#step-4:-complete-configuration-and-pick-model)  Step 4: Complete Configuration and Pick model
...
## [​](https://docs.z.ai/devpack/tool/crush\#step-5:-vision-search-reader-mcp)  Step 5: Vision Search Reader MCP

Refer to the [Vision MCP Server](https://docs.z.ai/devpack/mcp/vision-mcp-server) , [Search MCP Server](https://docs.z.ai/devpack/mcp/search-mcp-server) and [Web Reader MCP Server](https://docs.z.ai/devpack/mcp/reader-mcp-server) documentation; once configured, you can use them in Crush.
