---
url: "https://docs.z.ai/scenario-example/develop-tools/cline"
...
- [Step 1: Installing the Cline Plugin](https://docs.z.ai/scenario-example/develop-tools/cline#step-1:-installing-the-cline-plugin)
...
- [Step 2: Configuring API Settings](https://docs.z.ai/scenario-example/develop-tools/cline#step-2:-configuring-api-settings)
...
- [Step 3: Getting Started](https://docs.z.ai/scenario-example/develop-tools/cline#step-3:-getting-started)
- [Step 4: Vision Search Reader MCP](https://docs.z.ai/scenario-example/develop-tools/cline#step-4:-vision-search-reader-mcp)
...
## [​](https://docs.z.ai/scenario-example/develop-tools/cline\#step-1:-installing-the-cline-plugin)  Step 1: Installing the Cline Plugin

### [​](https://docs.z.ai/scenario-example/develop-tools/cline\#1-open-the-extensions-marketplace)  1\. Open the Extensions Marketplace
...
### [​](https://docs.z.ai/scenario-example/develop-tools/cline\#2-install-the-plugin)  2\. Install the Plugin
...
## [​](https://docs.z.ai/scenario-example/develop-tools/cline\#step-2:-configuring-api-settings)  Step 2: Configuring API Settings

### [​](https://docs.z.ai/scenario-example/develop-tools/cline\#1-select-api-key-method)  1\. Select API Key Method

Choose `Use your own API Key`![Description](https://cdn.bigmodel.cn/markdown/1753688131403c3.png?attname=c3.png)

### [​](https://docs.z.ai/scenario-example/develop-tools/cline\#2-enter-configuration-information)  2\. Enter Configuration Information
...
## [​](https://docs.z.ai/scenario-example/develop-tools/cline\#step-3:-getting-started)  Step 3: Getting Started
...
## [​](https://docs.z.ai/scenario-example/develop-tools/cline\#step-4:-vision-search-reader-mcp)  Step 4: Vision Search Reader MCP

Refer to the [Vision Understanding MCP Server](https://docs.z.ai/devpack/mcp/vision-mcp-server) [Web Search MCP Server](https://docs.z.ai/devpack/mcp/search-mcp-server) [Web Reader MCP Server](https://docs.z.ai/devpack/mcp/reader-mcp-server) documentation; once configured, you can use them in Cline.
