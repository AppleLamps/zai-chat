---
url: "https://docs.z.ai/devpack/tool/roo"
...
- [Step 1: Installing the Roo Code Plugin](https://docs.z.ai/devpack/tool/roo#step-1:-installing-the-roo-code-plugin)
...
- [Step 2: Configuring API Settings](https://docs.z.ai/devpack/tool/roo#step-2:-configuring-api-settings)
- [Configuration Details](https://docs.z.ai/devpack/tool/roo#configuration-details)
- [Step 3: Permission Setup and Usage](https://docs.z.ai/devpack/tool/roo#step-3:-permission-setup-and-usage)
...
- [Step 4: Vision Search Reader MCP](https://docs.z.ai/devpack/tool/roo#step-4:-vision-search-reader-mcp)
...
## [​](https://docs.z.ai/devpack/tool/roo\#step-1:-installing-the-roo-code-plugin)  Step 1: Installing the Roo Code Plugin

### [​](https://docs.z.ai/devpack/tool/roo\#1-open-the-extensions-marketplace)  1\. Open the Extensions Marketplace
...
### [​](https://docs.z.ai/devpack/tool/roo\#2-install-the-plugin)  2\. Install the Plugin

a. Click the `Install` button to begin installationb. After installation, select “Trust the Author”

## [​](https://docs.z.ai/devpack/tool/roo\#step-2:-configuring-api-settings)  Step 2: Configuring API Settings

### [​](https://docs.z.ai/devpack/tool/roo\#configuration-details)  Configuration Details
...
## [​](https://docs.z.ai/devpack/tool/roo\#step-3:-permission-setup-and-usage)  Step 3: Permission Setup and Usage

### [​](https://docs.z.ai/devpack/tool/roo\#1-configure-permissions)  1\. Configure Permissions
...
### [​](https://docs.z.ai/devpack/tool/roo\#2-start-coding)  2\. Start Coding
...
## [​](https://docs.z.ai/devpack/tool/roo\#step-4:-vision-search-reader-mcp)  Step 4: Vision Search Reader MCP

Refer to the [Vision MCP Server](https://docs.z.ai/devpack/mcp/vision-mcp-server) , [Search MCP Server](https://docs.z.ai/devpack/mcp/search-mcp-server) and [Web Reader MCP Server](https://docs.z.ai/devpack/mcp/reader-mcp-server) documentation; once configured, you can use them in Roo Code.
