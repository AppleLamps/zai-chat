---
url: "https://docs.z.ai/help/faq"
title: "FAQ - Z.AI DEVELOPER DOCUMENT"
---
...
- [How does cache works in GLM-4.5?](https://docs.z.ai/help/faq#how-does-cache-works-in-glm-4-5)
- [Why hasn’t my account balance changed after I used the API?](https://docs.z.ai/help/faq#why-hasn%E2%80%99t-my-account-balance-changed-after-i-used-the-api)
- [How can I check the rate limits?](https://docs.z.ai/help/faq#how-can-i-check-the-rate-limits)
- [How should I recharge?](https://docs.z.ai/help/faq#how-should-i-recharge)
- [Why can’t I recharge when using credit card?](https://docs.z.ai/help/faq#why-can%E2%80%99t-i-recharge-when-using-credit-card)

#### [​](https://docs.z.ai/help/faq\#how-does-cache-works-in-glm-4-5)  How does cache works in GLM-4.5?
...
#### [​](https://docs.z.ai/help/faq\#why-hasn%E2%80%99t-my-account-balance-changed-after-i-used-the-api)  Why hasn’t my account balance changed after I used the API?
...
#### [​](https://docs.z.ai/help/faq\#how-can-i-check-the-rate-limits)  How can I check the rate limits?

You can check the rate limits from here: [https://z.ai/manage-apikey/rate-limits](https://z.ai/manage-apikey/rate-limits)

#### [​](https://docs.z.ai/help/faq\#how-should-i-recharge)  How should I recharge?

You can recharge from the billing page: [https://z.ai/manage-apikey/billing](https://z.ai/manage-apikey/billing)

#### [​](https://docs.z.ai/help/faq\#why-can%E2%80%99t-i-recharge-when-using-credit-card)  Why can’t I recharge when using credit card?
